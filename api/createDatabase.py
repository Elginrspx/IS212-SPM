...
dummySection5 = Section(1,2,"1", "Lim's Class", 1)
...
dummyQN10 = Question(1,2,"1", "Lim is the best", "True", "True,False", "false")
dummyScore = Score(1,1,3,"1", "1", 1)
dummyScore2 = Score(2,1,3,"1", ".70", 3)
# dummyScore3 = Score(3,1,3,"2", ".30", 2)
# dummyScore4 = Score(2,1,3,"2", "1", 1)
dummyScore5 = Score(3,1,3,"2", ".50", 3)
